...
public class UserController {
    ...
    public UserSummary getCurrentUser(@CurrentUser UserPrincipal currentUser) {
        UserSummary userSummary = new UserSummary(currentUser.getId(), currentUser.getUsername(), currentUser.getName(), currentUser.getAddress(), currentUser.getTelephone());
        return userSummary;
    }
    @GetMapping("/user/all")
    ...
    public Optional<User> getToken(@PathVariable(value = "token") String token){
    ...
    public UserProfile getUserProfile(@PathVariable(value = "username") String username) {
        ...
        UserProfile userProfile = new UserProfile(user.getId(), user.getUsername(), user.getName(), user.getAddress(), user.getTelephone());
